...
function setupEventListeners() {
    ...
    // إضافة مستمعي أحداث لتحميل البيانات عند فتح النوافذ المنبثقة
    document.getElementById('countryModal').addEventListener('show.bs.modal', function() {
        loadCountriesTable();
    });
    
    document.getElementById('clubModal').addEventListener('show.bs.modal', function() {
        loadClubsTable();
    });
    
    document.getElementById('leagueModal').addEventListener('show.bs.modal', function() {
        loadLeaguesTable();
    });
